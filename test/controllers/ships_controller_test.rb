...
class ShipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ship" do
    assert_difference("Ship.count") do
      post ships_url, params: { ship: { comment: @ship.comment, health: @ship.health, name: @ship.name, x_location: @ship.x_location, y_location: @ship.y_location } }
    end
  ...
  test "should update ship" do
    patch ship_url(@ship), params: { ship: { comment: @ship.comment, health: @ship.health, name: @ship.name, x_location: @ship.x_location, y_location: @ship.y_location } }
